 ...
 --%>
			...
			<div class="content-wrapper">
				<div class="content">
					...
					<form:form action="${pageContext.request.contextPath}/AdSubject/savepage"  modelAttribute="subjects" method="Post">							<div class="row">
								<div class="col-sm-6">
											...
											<div class="col-sm-12">
												...
												<div class="panel-body">
													<div class="form-group">
														<form:hidden path="id"/>
														<form:label path="subjectName" class="req">Subject Name </form:label>
														<form:input path="subjectName" class="form-control"/>
													<form:errors path="subjectName" cssClass="error"></form:errors>
													</div>
													<div class="form-group">
														<form:label path="subjectCode" class="req">Subject Code </form:label>
															<form:input path="subjectCode" class="form-control"/>
										...
										<table class="items">
											<thead>
												<tr>
													...
													<th id="item-grid_c1">Subject Name </th>
													<th id="item-grid_c2">Subject Code</th>
													<th class="button-column" id="item-grid_c5">Manage</th>
												</tr>
											</thead>
											<tbody>
													<c:forEach var="SubjectList" items="${subjectlist}" varStatus="loop">
					<c:url var="update" value="/AdSubject/update">
						<c:param name="subjectId" value="${SubjectList.id}"></c:param>
					</c:url>
					<c:url var="Delete" value="/AdSubject/detele">
						<c:param name="subjectId" value="${SubjectList.id}"></c:param>
					</c:url>
