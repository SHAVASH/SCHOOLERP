			...
			<div class="content-wraper">
				<div class="content">
					...
					<div class="content">
                      ...
                      <form:form action="saveDesignation"  modelAttribute="Designationmodel" method="post">  
                       
                       <div class="row">
								<div class="col-sm-6">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Designation</h4>
										</div>
				                      ...
				                      <form:label path="designationName">Designation Name</form:label>
				                        <form:input class="form-control" path="designationName"/>
				                        </div>
													<div class="row">
														<div class="col-sm-5">
															<div class="form_sep">
										...
										<table class="items">
											<thead>
												<tr>
													...
													<th id="item-grid_c1">Designation</th>
													<th class="button-column" id="item-grid_c5">Manage</th>
												</tr>
											</thead>
											<tbody>
							
				<c:forEach var="Designation" items="${Designationdata}">
					<c:url var="update" value="/addDepart/DesignationshowForm">
						<c:param name="DesignationId" value="${Designation.id}"></c:param>
					</c:url>		
					...
					<tr>
						...
						<td><a  class="icon-pencil" href="${update}"></a>
