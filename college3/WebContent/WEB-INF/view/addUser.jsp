...
<body class="pace-done">
 ...
 --%>
			...
			<div class="content-wra er">
				<div class="content">
					...
					<div class="content">
                     ...
                     <form:form action="saveuser"  modelAttribute="Usermodel" method="post">       
      ...
      <div class="col-sm-6">
					...
					<c:url var="update" value="/addDepart/usershowForm">
