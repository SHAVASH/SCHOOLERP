...
<body class="pace-done">
	...
	<div class="content-wr apper">
		<div class="content" style="margin-left:1px;">
			...
			<br>
			<div class="content">
				<form:form action=""  modelAttribute="employeemodel" method="Post" enctype="multipart/form-data" >
					<div class="row">
						<div class="col-sm-12">
											...
											<div class="col-sm-6">
												<div class="panel panel-default">
													...
													<div class="panel-body">
														...
														<div class="form-group">
															<form:label  path="uploadPhoto">Upload Photo</form:label>
															
																<form:input path="uploadPhoto" type="file"/> 
															
															
														
															<div class="school_val_error" style="display: none"></div>
														</div>
													</div>
												</div>
											</div>
