...
<body class="pace-done">
 ...
 --%>
			...
			<div class="content-wrapper">
				...
				<form:form action="${pageContext.request.contextPath}/assignSub/savepage"  modelAttribute="Assign"  method="post">	<div class="row">
								<div class="col-sm-6">
											...
											<div class="col-sm-12">
												...
												<div class="form-group">
													<div class="form-group">
														...
														<c:forEach var="DepartList" items="${Depart}">
														<form:option value="${DepartList.id}" label="${DepartList.}"></form:option>
														</c:forEach>
														</form:select>
													
													</div>
													
														<form:label path="employee" class="req"> Employee Name</form:label>
														<form:select path="employee" class="form-control">
														<form:option value="None" >Please Select</form:option>
														<c:forEach var="emplist" items="${employeelist}">
														<form:option value="${emplist.id}" label="${emplist.}"></form:option>
														</c:forEach>
														</form:select>
								...
								<div class="col-sm-6">
									<div class="grid-view table-responsive" id="item-grid">
										<table class="items">
											...
											<tbody>
												<c:forEach var="AssignSub_List" items="${AssignSubjectList}" varStatus="loopCounter">


													 <c:url var="updatelink" value="/assignSub/showFromForUpdate">
														<c:param name="assignId" value="${AssignSub_List.id}"></c:param>
													</c:url>

													<c:url var="Deletelink" value="/assignSub/DeleteFrom">
														<c:param name="assignId" value="${AssignSub_List.id}"></c:param>
													</c:url>
													...
													<tr>
														...
														<td>${AssignSub_List.course.courseName}</td>
														<td>${AssignSub_List.batch.batchName}</td>
														<td>${AssignSub_List.subject.subjectName}</td>
