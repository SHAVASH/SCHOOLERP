 ...
 --%>
			...
			<div class="content-wrapper">
				<div class="content">
											...
											<div class="col-sm-12">
												...
												<div class="panel-body">
													<div class="form-group">
															<form:hidden path="id" />
														<form:label path="courseName" class="req">Course Name </form:label>
													...
													<div class="form-group">
														<form:label path="minimumAttendance" class="req">Minimum Attendance Percentage</form:label>
														<form:input path="minimumAttendance" class="form-control"
															 type="text" maxlength="3" />
															<form:errors path="minimumAttendance" cssClass="error"></form:errors>
														</div>
														<div class="form-group">
															<form:label path="attendanceType">Attendance Type</form:label>
															<form:select path="attendanceType" class="form-control">
																<form:option value="">Please Select</form:option>
																	<form:option value="Daily">Daily</form:option>
																		<form:option value="Subject Wise">Subject Wise</form:option>
																	</form:select>
															</div>
														<div class="form-group">
															<form:label path="totalDays" class="req">Total Working Days</form:label>
															<form:input path="totalDays" class="form-control"
																 type="text" maxlength="4" />
																 <form:errors path="totalDays" cssClass="error"></form:errors>
																 
															</div>
															<div class="form-group">
																<form:label path="syllabusName" class="req">Syllabus Name</form:label>
																<form:select path="syllabusName" class="form-control">
																	<form:option value="">Select Syllabus</form:option>
																	<form:option value="GPA">GPA</form:option>
																	<form:option value="CCE">CCE</form:option>
																	</form:select>
																	<form:errors path="syllabusName" cssClass="error"></form:errors>
															</div>
					...
					<c:url var="update" value="/course/showForm" >
					...
					<tr>
						...
						<td>${course.attendanceType }
						<td>${course.minimumAttendance }</td>
						<td>${course.totalDays}</td>
						<td><a class="icon-cross2" href="${Delete}"onclick="if(!(confirm('are sure delete this')))return false"></a>
						<a  class="icon-pencil" href="${update}"></a><br>
					</tr>
