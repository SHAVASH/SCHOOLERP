 ...
 --%>
			...
			<div class="content-wrapper">
				<div class="content">
					...
					<br>
					<div class="content">
				<form:form action="savepage" modelAttribute="academic" method="post">
							<div class="row">
								<div class="col-sm-6">
											...
											<div class="col-sm-12">
												...
												<div class="panel-body">
													...
													<div class="form-group">
														<form:hidden path="id" />
														<form:label path="startYear" class="req">Start Year</form:label>
														<form:select path="startYear" class="form-control">
															<form:option value="0" label="Please Select"></form:option>
															<form:options items="${numbersList }" />
														</form:select>
													</div>

													<div class="form-group">

														<form:label path="startMonth" class="req">Start Month</form:label>
													...
													<div class="form-group">
														...
														<form:label path="endMonth"  class="req">End Month</form:label>
													...
													<div class="form-group">
														...
														<form:label path="endYear" class="req">End Year</form:label>
													...
													<div class="form-group">
														<form:label path="activeDeactive">Active / Deactive </form:label>
														<form:select path="activeDeactive" class="form-control">
															<form:option value="None" label="Please Select"></form:option>
															<form:option value="Active"></form:option>
															<form:option value="Deactive"></form:option>
															<form:options />
														</form:select>
										...
										<table class="items">
											<thead>
												<tr>
													...
													<th id="item-grid_c1">Start Year</th>
													<th id="item-grid_c2">Start Month</th>
													<th id="item-grid_c3">End Month</th>
													<th id="item-grid_c4">End Year</th>
													<th class="button-column" id="item-grid_c5">Manage</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach var="data" items="${listacademic}">


													<tr>
														<td>${data.id}</td>
														<td>${data.startYear}</td>
														<td><c:forEach var="month" items="${months}">
																<c:if test="${month.key == data.startMonth}">${month.value}</c:if>
															</c:forEach></td>
														<td><c:forEach var="month" items="${months}">
																<c:if test="${month.key == data.endMonth}">${month.value}</c:if>
															</c:forEach></td>

														<td>${data.endYear}</td>
														<td>${data.activeDeactive}</td>
													</tr>
				...
				<div class="navbar navbar-default navbar-sm navbar-fixed-bottom">
					...
					<div id="navbar-second" class="navbar-collapse collapse">
						<div class="navbar-text">© 2018. Webschool byS Technologies
							Pvt Ltd. V4.1</div>
					</div>
				</div>
			</div>
