 ...
 --%>
			...
			<div class="content-wrapper">
				<div class="content">
											...
											<div class="col-sm-12">
												...
												<div class="panel-body">
													...
													<div class="form-group">
														<form:hidden path="id"/>	
														<form:label path="categoryName" class="req">Category Name </form:label>
														<form:input path="categoryName" class="form-control" type="text" />
														<form:errors path="categoryName" cssClass="error"></form:errors>
													</div>
													<div class="form-group">
														<form:label path="sectionCode">Section Code</form:label>
														<form:input path="sectionCode" class="form-control" type="text" />
													</div>
					...
					<c:url var="update" value="/category/showid">
						<c:param name="categoryId" value="${category.id}"></c:param>
					</c:url>
					<c:url var="Delete" value="/category/deletes">
						<c:param name="categoryId" value="${category.id}"></c:param>
					</c:url>
