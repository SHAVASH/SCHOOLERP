...
<body class="pace-done">
			...
			<div class="content-wrapper">
				<div class="content">
					...
					<div class="content">
						...
						<form:form action="${pageContext.request.contextPath}/page/savepage" modelAttribute="batches"
							method="Post">
							<div class="row">
								<div class="col-sm-6">
											...
											<div class="col-sm-12">
												...
												<div class="panel-body">
													<div class="form-group">
														<form:hidden path="id" />
														<form:label path="shotcourse" class="req">Course </form:label>

														<form:select class="form-control" path="shotcourse">

															<form:option value="None" label="Please Select"></form:option>
															<c:forEach var="process" items="${listcode}">

																<form:option value="${process.id }">${process.courseName}</form:option>
 ...
 --%>
													...
													<div class="form-group">
														...
														<form:label path="batchName" class="req">Batch Name </form:label>
														<form:input path="batchName" class="form-control" required="required" />
														
														<form:errors path="batchName" cssClass="error"></form:errors>
													</div>
													...
													<div class="form-group">
														...
														<div class="form-group">
														<form:label path="maxi_student" class="req" >Maximum Number of Students</form:label>

														<form:input path="maxi_student" class="form-control" required="required"/>

														<form:errors path="maxi_student" cssClass="error"></form:errors>
														</div>
										...
										<table class="items">
											<thead>
												<tr>
													...
													<th id="item-grid_c2">Batch name</th>
													<th id="item-grid_c3">start date</th>
													<th id="item-grid_c4">end date</th>
													<th id="item-grid_c4">maximum number student</th>
													<th class="button-column" id="item-grid_c5">Manage</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach var="batch" items="${showdata}" varStatus="loopCounter">


													<c:url var="updatelink" value="/page/updateform">
													...
													<tr>
														...
														<td>${batch.shotcourse.courseName}</td>
														<td>${batch.batchName}</td>
														<td>${batch.startdate}</td>
														<td>${batch.enddate}</td>
														<td>${batch.maxi_student}</td>
