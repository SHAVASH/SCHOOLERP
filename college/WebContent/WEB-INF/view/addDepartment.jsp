 ...
 --%>
				...
				<div class="content">
					...
					<div class="content">
                      <div class="form-group">        
                       <form:form action="savepage"  modelAttribute="Departmodel" method="post">  
								...
								<div class="col-sm-6">
									<div class="panel panel-default">
										...
										<div class="panel-body">
                                          ...
                                          <div class="form-group">
				                        <form:hidden path="id"/>  
				                      <form:label path="departName">Department Name</form:label>
				                        <form:input class="form-control" path="departName"/>
				                        </div>
													<div class="row">
														<div class="col-sm-5">
															<div class="form_sep">
      ...
      <div class="col-sm-6">
				...
				<c:forEach var="Department" items="${Depart}">
					<c:url var="update" value="/addDepart/showForm">
						<c:param name="departId" value="${Department.id}"></c:param>
					</c:url>		
