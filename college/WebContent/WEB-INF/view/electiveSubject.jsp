<!DOCTYPE html>
<!-- saved from url=(0065)http://demo.web-school.in/index.php/core/subject/electivesubjects -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" type="text/css" href="./ElectiveSubject_files/styles.min.css">
<link rel="stylesheet" type="text/css" href="./ElectiveSubject_files/grid.css">
<link rel="stylesheet" type="text/css" href="./ElectiveSubject_files/jquery-ui.css">
<script src="./ElectiveSubject_files/ca-pub-6418783984253654.js"></script> <script src="${pageContext.request.contextPath}/resources/js1/jquery.min.js"></script>
 <script src="${pageContext.request.contextPath}/resources/js1/jquery.ba-bbq.min.js"></script>
 <script src="${pageContext.request.contextPath}/resources/js1/jquery.yiiactiveform.js"></script>
...
<link type="text/css" rel="stylesheet"
	...
	rel="stylesheet" type="text/css">
        /*.active a { color: red; }*/
    </style><link rel="preload" href="./ElectiveSubject_files/integrator.js" as="script"> <script src="${pageContext.request.contextPath}/resources/js1/integrator.js"></script><link rel="preload" href="./ElectiveSubject_files/integrator(1).js" as="script"> <script src="${pageContext.request.contextPath}/resources/js1/integrator(1).js"></script><script data-require-id="echarts/theme/limitless" src="./ElectiveSubject_files/limitless.js" async=""></script></head>
...
<div class="pace-activity"></div></div>
        <div class="navbar navbar-default header-highlight">
            <div class="navbar-header">
                <a class="navbar-brand" href="http://demo.web-school.in/index.php/core/subject/electivesubjects#"><img src="./ElectiveSubject_files/logo-1t.png" alt=""></a>
            ...
            <div class="navbar-collapse collapse" id="navbar-mobile">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-content width-350">
                            ...
                            <div class="dropdown-content-footer">
                                    ...
                                    <img src="./ElectiveSubject_files/placeholder.jpg" alt="">
                                    <span>admin</span>
                                    <i class="caret"></i>
                                </a>
                    ...
                    <div class="sidebar-content">
                        <div class="sidebar-user">
                            <div class="category-content">
                                                                    <div class="media">
                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="media-left"><img src="./ElectiveSubject_files/29012018062459.png" class="img-circle img-sm" alt=""></a>
                                    ...
                                    <div class="category-content no-padding">
                                        <ul class="navigation navigation-main navigation-accordion">
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-home4"></i><span>Dashboard</span></a>
                                                <ul data-index="0" style="display: none;" class="hidden-ul">
                                                    <li><a href="#">Dashboard</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-cogs"></i><span>Settings</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li class="active">
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-users4"></i><span>Academic</span></a>
                                                <ul>
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Course &amp; Batch</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li class="active">
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Subjects</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects" class="active">Elective Subject</a></li>
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Lesson Planning</a>
                                                        <ul class="hidden-ul">
                                                            <li><a href="http://demo.web-school.in/index.php/core/lessonplanning/create">Lesson Planning</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Time Table</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Exams</a>
                                                        <ul class="hidden-ul">
                                                            <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">GPA</a>
                                                                <ul class="hidden-ul">
                                                                    ...
                                                                    <li>
                                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">GPA Grade System</a>
                                                                        <ul class="hidden-ul">
                                                            ...
                                                            <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">CCE</a>
                                                                <ul class="hidden-ul">
                                                                    <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Initial Settings</a>
                                                                        <ul class="hidden-ul">
                                                                    ...
                                                                    <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">CCE Exam</a>
                                                                        <ul class="hidden-ul">
                                                            ...
                                                            <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Exam Hall</a>
                                                                <ul class="hidden-ul">
                                                            ...
                                                            <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Online Exam</a>
                                                                <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Assignments &amp; Notes</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Certifications</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Placements</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Promotion &amp; Alumni</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Occurrence</a>
                                                        <ul class="hidden-ul">
                                                            <li><a href="http://demo.web-school.in/index.php/core/occurance/create">Occurrence Register </a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Circular</a>
                                                        <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-eye"></i><span>HR/Payroll</span></a>
                                                <ul class="hidden-ul">
                                                    <!--<li><a href="/index.php/core/employeemaster/adminusers">Admin Users</a></li>-->
                                                    <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Employee Management</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Payroll</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Leave Management</a>
                                                        <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-user"></i><span>Student</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-cash3"></i><span>Finance</span></a>
                                                <ul class="hidden-ul">
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Fees</a>
                                                        <ul class="hidden-ul">
                                                    ...
                                                    <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Accounting</a>
                                                        <ul class="hidden-ul">
                                                            ...
                                                            <li>
                                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Report</a>
                                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class=" icon-book3"></i><span>Library</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-truck"></i><span>Transport</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class=" icon-home2"></i><span>Hostel</span></a>
                                                <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Reports</a>
                                                        <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-envelope"></i><span>Messages/SMS</span></a>
                                                <ul class="hidden-ul">
                                                    ...
                                                    <li>
                                                        <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">Email</a>
                                                        <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class=" icon-list-unordered"></i><span>Store Management</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class=" icon-stats-growth"></i><span>Performance</span></a>
                                                <ul class="hidden-ul">
                                                    <!--<li><a href="/index.php/core/employeemaster/adminusers">Admin Users</a></li>-->
                                                    <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul">GPA</a>
                                                        <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-star-full2"></i><span>Events</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class=" icon-link2"></i><span>Integration</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-file-text"></i><span>Task Manager</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="icon-copy3"></i><span>Reports</span></a>
                                                <ul class="hidden-ul">
                                            ...
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class=" icon-paperplane"></i><span>Withdrawal</span></a>
                                                <ul class="hidden-ul">
                                                    <li><a href="http://demo.web-school.in/index.php/core/student/withdrawal">Withdrawal</a> </li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="glyphicon glyphicon-cloud-download"></i><span>Data Export</span></a>
                                                <ul class="hidden-ul">
                                                    <li><a href="http://demo.web-school.in/index.php/site/dataexport">Export</a> </li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#" class="has-ul"><i class="glyphicon glyphicon-cloud-download"></i><span>Moodle</span></a>
                                                                                                    <ul class="hidden-ul">
...
<div class="page-header">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon-home2 position-left"></i>Home</a></li>
            <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#">Academic</a></li>
            <li><a href="http://demo.web-school.in/index.php/core/subject/electivesubjects#">Subjects</a></li>
...
<div class="content">
    <form id="assignsubject-form" action="http://demo.web-school.in/index.php/core/subject/electivesubjectscreate" method="post">
    <div class="row">
        <div class="col-sm-6">
...
<option value="">Select Subject</option>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form_sep">
                                <input class="btn btn-info" id="submit" onclick=" return validate()" type="submit" name="yt0" value="Save">                            </div>
                        </div>
                    </div>
                </div>
...
<tbody>
<tr class="odd">
<td width="5%">1</td><td width="20%">STD 2</td><td width="20%">Yellow</td><td width="20%">JACINTA  MWANGI</td><td width="45%">MATHEMATICS  -  MAT</td><td width="10%">  <a class="icon-cross2" title="" href="http://demo.web-school.in/index.php/core/subject/deleteelective/id/9"><img src="http://demo.web-school.in/index.php/core/subject/electivesubjects" alt=""></a></td></tr>
<tr class="even">
<td width="5%">2</td><td width="20%">STD 2</td><td width="20%">Yellow</td><td width="20%">kuria james sd</td><td width="45%">SCIENCE  -  SCI</td><td width="10%">  <a class="icon-cross2" title="" href="http://demo.web-school.in/index.php/core/subject/deleteelective/id/8"><img src="http://demo.web-school.in/index.php/core/subject/electivesubjects" alt=""></a></td></tr>
<tr class="odd">
<td width="5%">3</td><td width="20%">STD I</td><td width="20%">Yellow</td><td width="20%">Rahul  Kumaf</td><td width="45%">SCIENCE  -  SCI</td><td width="10%">  <a class="icon-cross2" title="" href="http://demo.web-school.in/index.php/core/subject/deleteelective/id/6"><img src="http://demo.web-school.in/index.php/core/subject/electivesubjects" alt=""></a></td></tr>
<tr class="even">
<td width="5%">4</td><td width="20%">STD I</td><td width="20%">Blue</td><td width="20%">Ram kumar Khurana</td><td width="45%">SCIENCE  -  SCI</td><td width="10%">  <a class="icon-cross2" title="" href="http://demo.web-school.in/index.php/core/subject/deleteelective/id/5"><img src="http://demo.web-school.in/index.php/core/subject/electivesubjects" alt=""></a></td></tr>
<tr class="odd">
<td width="5%">5</td><td width="20%">STD I</td><td width="20%">Blue</td><td width="20%">Sakuda  Moses</td><td width="45%">SCIENCE  -  SCI</td><td width="10%">  <a class="icon-cross2" title="" href="http://demo.web-school.in/index.php/core/subject/deleteelective/id/4"><img src="http://demo.web-school.in/index.php/core/subject/electivesubjects" alt=""></a></td></tr>
<tr class="even">
<td width="5%">6</td><td width="20%">STD 2</td><td width="20%">Yellow</td><td width="20%">saji s saji</td><td width="45%">SCIENCE  -  SCI</td><td width="10%">  <a class="icon-cross2" title="" href="http://demo.web-school.in/index.php/core/subject/deleteelective/id/3"><img src="http://demo.web-school.in/index.php/core/subject/electivesubjects" alt=""></a></td></tr>
</tbody>
</table>
<div class="keys" style="display:none" title="/index.php/core/subject/electivesubjects"><span>9</span><span>8</span><span>6</span><span>5</span><span>4</span><span>3</span></div>
</div>  
        </div>
    </div>
    </form></div>
<script>
    function validate() {
        var courseid=$('#Electivesubject_courseid').val();
        var batchid=$('#Electivesubject_batchid').val();
        if(courseid==""|| batchid==""){
    ...
    $(document).ready(function ()
    {
        ...
        $(document).bind('keypress', function (e) {
            if (e.keyCode == 13) {
                ...
                document.assignsubject - form.submit();
            }
        });
    });
</script>
...
/*<![CDATA[*/
jQuery(function($) {
jQuery('body').on('change','#Electivesubject_courseid',function(){jQuery.ajax({'type':'POST','url':'/index.php/core/Subject/Fetchbatchforelective','cache':false,'data':jQuery(this).parents("form").serialize(),'success':function(html){jQuery("#Electivesubject_batchid").html(html)}});return false;});
jQuery('body').on('change','#Electivesubject_batchid',function(){jQuery.ajax({'type':'POST','url':'/index.php/core/subject/Fetchsubjectforelective','cache':false,'data':jQuery(this).parents("form").serialize(),'success':function(html){jQuery("#Electivesubject_subjectid").html(html)}});return false;});
jQuery('body').on('change','#Electivesubject_subjectid',function(){jQuery.ajax({'type':'POST','url':'/index.php/core/subject/Fetchstudentforelective','cache':false,'data':jQuery(this).parents("form").serialize(),'success':function(html){jQuery("#Electivesubject_studentid").html(html)}});return false;});
...
jQuery('#item-grid').yiiGridView({'ajaxUpdate':['1','item-grid'],'ajaxVar':'ajax','pagerClass':'pager','loadingClass':'grid-view-loading','filterClass':'filters','tableClass':'items','selectableRows':1,'enableHistory':false,'updateSelector':'{page}, {sort}','filterSelector':'{filter}','pageVar':'Electivesubject_page'});
jQuery('#assignsubject-form').yiiactiveform({'validateOnChange':false,'validateOnSubmit':true,'attributes':[{'id':'Electivesubject_courseid','inputID':'Electivesubject_courseid','errorID':'Electivesubject_courseid_em_','model':'Electivesubject','name':'courseid','enableAjaxValidation':true},{'id':'Electivesubject_batchid','inputID':'Electivesubject_batchid','errorID':'Electivesubject_batchid_em_','model':'Electivesubject','name':'batchid','enableAjaxValidation':true},{'id':'Electivesubject_subjectid','inputID':'Electivesubject_subjectid','errorID':'Electivesubject_subjectid_em_','model':'Electivesubject','name':'subjectid','enableAjaxValidation':true},{'id':'Electivesubject_studentid','inputID':'Electivesubject_studentid','errorID':'Electivesubject_studentid_em_','model':'Electivesubject','name':'studentid','enableAjaxValidation':true}],'errorCss':'error'});
...
<!-- Theme JS files -->
 ...
 <script src="${pageContext.request.contextPath}/resources/js1/line.js"></script>
<!-- custom fonts -->
<script src="./ElectiveSubject_files/country.js"></script>
<script>
                                                    $(function () {
