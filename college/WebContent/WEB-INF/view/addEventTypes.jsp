			...
			<div class="content">
				...
				<div class="content">
					<div class="form-group">
						<form:form action="saveLeaveCategory"
							modelAttribute="LeaveCategorymodel" method="post">

							<div class="row">
								<div class="col-sm-6">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Event Types</h4>
										</div>
										<div class="panel-body">
											<div class="col-sm-12">
												...
												<div class="panel-body">
													...
													<div class="form-group">
														<form:hidden  path="id" />
														<form:label path="eventType" > </form:label>
														<form:input class="form-control" path="eventType" />
													</div>
													<div class="row">
														<div class="col-sm-5">
															<div class="form_sep">
										...
										<table class="items">
											<thead>
												<tr>
													...
													<th id="item-grid_c1">Leave Category Name</th>
													<th class="button-column" id="item-grid_c5">Manage</th>
												</tr>
											</thead>
											<tbody>
												<%-- 	<c:forEach var="listLeaveCategory" items="${LeaveCategorydata}">
					
							
				
					<tr>
						<td>${listLeaveCategory.id}</td>
						<td>${listLeaveCategory.leaveCategoryName}</td>
...
submit = function(){
        ...
        $.ajax({
            url:'saveOrUpdate',
            type:'POST',
            data:{user_id:$("#id").val(),user_name:$('#name').val().val()},
...
load=function(){
	$ajax({
		...
		sucess: function(response){
			data=data.response;
			$('.tr').remove();
			for(i=o;i<data.response.length;i++)
				$(#table).append("<tr class='tr'>"+response.data[i].leaveCategoryName+"</td><td><a href='#' onclick=edit("+i+");>update</td><td><a href='#' onclick=delete_("+response.data[i].id+");>Delete</td>")
				}
	}
