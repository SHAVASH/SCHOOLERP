 ...
 --%>
			...
			<div class="content-wrap per">
				<div class="content">
					...
					<div class="page-header">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li><a
									href="##">HR/Payroll</a></li>
									<li><a
									href="#">Leave Management</a></li>
					...
					<div class="content">
							...
							<div class="row">
								<form:form action="${pageContext.request.contextPath}/LevDetails/savepage" modelAttribute="LeaveDetailModel"
							method="post">
								<div class="col-sm-6">
											...
											<div class="col-sm-12">
												...
												<div class="panel-body">
													<div class="form-group">
														<form:hidden path="id" />
														<form:label path="leaveCategory">Leave Category </form:label>

														<form:select class="form-control" path="leaveCategory">

															<form:option value="None" label="Please Select"></form:option>
															<c:forEach var="Lea_Category" items="${LeaveCategorydata}">

																<form:option value="${Lea_Category.id }">${Lea_Category.leaveCategoryName}</form:option>
													...
													<div class="form-group">
														...
														<form:label path="design">Designation </form:label>
													<form:select class="form-control" path="design">

															<form:option value="None" label="Please Select"></form:option>
															<c:forEach var="process" items="${Designationdata}">

																<form:option value="${process.id}">${process.designationName}</form:option>
														...
														<form:errors path="design" cssClass="error"></form:errors>
													</div>

													<div class="form-group">
														<form:label path="leaveCount">Leave Count</form:label>

														<form:input path="leaveCount" 
															class="form-control" />
										...
										<table class="items">
											<thead>
												<tr>
													...
													<th id="item-grid_c1">Leave Category</th>
													<th id="item-grid_c2">Designation </th>
													<th id="item-grid_c4">Leave Count  </th>
													<th class="button-column" id="item-grid_c5">Manage</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach var="LevDetailList" items="${LeaveDetailList}" varStatus="loopCounter">


													<c:url var="updatelink" value="${pageContext.request.contextPath}/LevDetails/showForm">
														<c:param name="LeaveDetailId" value="${LevDetailList.id}"></c:param>
													</c:url>

												<%--	<c:url var="Deletelink" value="/page/Delete">
														<c:param name="batchId" value="${batch.id}"></c:param>
													</c:url> --%>


													<tr>
														<td>${loopCounter.count}</td>
														<td>${LevDetailList.leaveCategory.leaveCategoryName}</td>
														<td>${LevDetailList.design.designationName}</td>
															<td>${LevDetailList.leaveCount}</td>
														<td><a href="${updatelink}" class="icon-pencil"></a>
															<a href="${Deletelink}" class="icon-cross2"
			...
			<div class="navbar navbar-default navbar-sm navbar-fixed-bottom">
				...
				<div id="navbar-second" class="navbar-collapse collapse">
					<div class="navbar-text">© 2018. Webschool by S
