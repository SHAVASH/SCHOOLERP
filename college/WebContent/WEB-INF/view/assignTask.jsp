			...
			<div class="content-wrapper">
				<div class="content">
					...
					<div class="content">
						...
						<form:form action="savepage" modelAttribute="batches"
							method="Post">
							<div class="row">
								<div class="col-sm-6">
											...
											<div class="col-sm-12">
												...
												<div class="panel-body">
													<div class="form-group">
														<form:hidden path="id" />
														<form:label path="">Task </form:label>

														<form:input path="batchName" class="form-control" />


														<form:errors path="shotcourse" cssClass="error"></form:errors>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<form:label path="batchName"> Priority </form:label>
														<form:select path="">
														<form:option value="none">Please Priority</form:option>
														<form:option value="Highest  Priority">Highest  Priority</form:option>
														<form:option value="High Priority">High  Priority</form:option>
														<form:option value="Normal Priority">Normal  Priority</form:option>
														<form:option value="Low Priority">Low  Priority</form:option>
														</form:select>
													...
													<div class="form-group">
														<form:label path="">Task Date</form:label>
