				...
				<div class="content">
					...
					<div class="content">
                      <div class="form-group">        
                       <form:form action="saveLeaveCategory"  modelAttribute="LeaveCategorymodel" method="post">  
                       
                       <div class="row">
								<div class="col-sm-6">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Leave Category</h4>
										</div>
										<div class="panel-body">
                                          ...
                                          <div class="form-group">
				                        <form:hidden path="id"/>  
				                      <form:label path="leaveCategoryName">Leave Category Name</form:label>
				                        <form:input class="form-control" path="leaveCategoryName"/>
				                        </div>
													<div class="row">
														<div class="col-sm-5">
															<div class="form_sep">
