			...
			<div class="content-wrapper">
				<div class="content">
					...
					<div class="content">
						...
						<form:form action="savepage" modelAttribute="teachermodel"
							method="Post">
							<div class="row">
								<div class="col-sm-6">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Class Allocation</h4>
										</div>
												...
												<div class="panel-body">
													<div class="form-group">
														...
														<form:select path="course" class="form-control">
															...
															<c:forEach var="process" items="${courses}">
																<form:option value="${process.id}"
																	label="${process.courseName}"></form:option>
															</c:forEach>
														</form:select>
													</div>
													...
													<div class="form-group">
														...
														<form:select path="batch" class="form-control">
															<form:option value="0" label="Please Select">Please Select</form:option>
															<c:forEach var="batchitem" items="${showdata}">
																<form:option value="${batchitem.id}"
													...
													<div class="form-group">
														<form:label path="classteah">Class Teacher</form:label>
														<form:select path="classteah" class="form-control">
										...
										<table class="items">
											<thead>
												<tr>
													...
													<th id="item-grid_c3">Class Teacher</th>
													<th class="button-column" id="item-grid_c5">Manage</th>
												</tr>
											</thead>
											<tbody>

												<c:forEach var="teach" items="${listteach}">
													<c:url var="update" value="/teacherpage/getid">
														<c:param name="teachId" value="${teach.id}"></c:param>
													</c:url>
													<c:url var="Delete" value="/teacherpage/delete">
														<c:param name="teachId" value="${teach.id}"></c:param>
													</c:url>
													...
													<tr>
														...
														<td>${teach.batch.batchName}</td>
														<td>${teach.classteah}</td>
														<td><a class="icon-cross2" href="${Delete}"
															onclick="if(!(confirm('are sure delete this')))return false"></a>
